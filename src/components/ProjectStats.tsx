...
const SHORT: Record<string, string> = {
  ...
  'Fruit Fly Connectome RNN': 'Connectome RNN',
  'ML Algorithms From Scratch in C++': 'ML From Scratch (C++)',
...
const FIELD_MAP: Record<string, string[]> = {
  ...
  'Fruit Fly Connectome RNN':                                                             ['Machine Learning'],
  'ML Algorithms From Scratch in C++':                                                    ['Machine Learning'],
...
const LANG_MAP: Record<string, string[]> = {
  ...
  'Fruit Fly Connectome RNN':                                                             ['Python'],
  'ML Algorithms From Scratch in C++':                                                    ['C++'],
